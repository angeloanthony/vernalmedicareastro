...
Done for the week? Re-run `npm run seo` after the next build — the queue recomputes from the new HTML, the new git history and the latest Search Console export.
