...
| Pages built (EN) | 153 |
| Pages built (ES) | 16 |
| Registered in `pageIndex.ts` | 153 |
...
| Pages with **zero** impressions | 37 |
...
| Priority 3 | 93 | score < 48 — maintain |
...
| AI readiness < 70% | 65 | [AI-READINESS](AI-READINESS.md) |
...
| --- | ---: |
| AI readiness | 68% |
| Words per page | 1,361 |
| In-content inbound links | 12.3 |
| Click depth from home | 2.4 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| part-d | 47 | 2,994 | 13 | 20.6 | 77% |
| local | 21 | 1,396 | 27 | 7.0 | 63% |
| medicare-101 | 27 | 940 | 0 | 50.1 | 63% |
| other-insurance | 3 | 870 | 2 | 27.0 | 63% |
| costs-irmaa | 11 | 492 | 1 | 26.5 | 67% |
| enrollment | 18 | 221 | 1 | 40.2 | 70% |
| dual-eligible | 7 | 217 | 3 | 16.2 | 66% |
| medigap | 4 | 122 | 0 | 21.2 | 78% |
| trust | 5 | 87 | 0 | 3.6 | 41% |
| tools | 2 | 29 | 0 | 56.1 | 55% |
| medicare-advantage | 4 | 13 | 0 | 3.8 | 74% |
| providers | 4 | 9 | 0 | 7.1 | 56% |
