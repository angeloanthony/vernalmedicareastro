...
export const strings = {
  en: {
    ...
    'contactFab.text': 'Text Us',
    'contactFab.smsBody': 'Hi {agent}, I have a Medicare question.',
    'contactFab.desktopHint': 'Text {agent} from your phone at {phone}',
    'contactFab.close': 'Close',
    // Footer
  ...
  es: {
    ...
    'contactFab.smsBody': 'Hola {agent}, tengo una pregunta sobre Medicare.',
    'contactFab.desktopHint': 'Envíe un mensaje de texto a {agent} desde su teléfono al {phone}',
    'contactFab.close': 'Cerrar',
