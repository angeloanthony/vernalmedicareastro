...
export const NEWS_ARTICLES: NewsArticle[] = [
  {
    ...
    learnMoreHref: 'part-d-plans-vernal.html', learnMoreLabel: 'Part D plans',
  ...
  },
  {
    ...
    related: [{ href: 'part-d-plans-vernal.html', label: 'Part D plans' }],
  ...
  },
  {
    ...
    learnMoreHref: 'medicare-advantage-plans-vernal.html', learnMoreLabel: 'Medicare Advantage plans',
  ...
  },
  {
    ...
    related: [{ href: 'part-d-plans-vernal.html', label: 'Part D plans' }, { href: 'tier-3-vs-tier-4-medicare-part-d.html', label: 'Drug tiers explained' }],
