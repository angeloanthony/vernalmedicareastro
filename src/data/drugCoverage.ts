...
export const DRUG_COVERAGE: DrugCoverageEntry[] = [
  // ── Diabetes ─────────────────────────────────────────────────────────────
  {
    ...
    tier: 'Brand tier (often Tier 3) — varies by plan',
  ...
  // ── Heart & Blood ────────────────────────────────────────────────────────
  {
    ...
    whichPart: PART_D_SELF,
    tier: 'Preferred brand (often Tier 3)',
  ...
  },
  {
    ...
    whichPart: PART_D_SELF,
    tier: 'Brand or specialty tier — varies by plan',
  ...
  // ── Autoimmune & Skin ────────────────────────────────────────────────────
  {
    ...
    whichPart: PART_D_SELF,
    tier: 'Specialty tier (typically Tier 5)',
  ...
  // ── Weight & Metabolic ───────────────────────────────────────────────────
  {
    ...
    tier: 'Not typically on a formulary for weight loss',
